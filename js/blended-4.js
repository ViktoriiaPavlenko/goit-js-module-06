...
// document.writeln(limitStr('Каждый охотник желает знать.',17)); // Каждый охотник же...
...
// 2
// str = str.split(",");
// let uniqueElements = str.filter((item, pos, self) => {
//     return self.indexOf(item) == pos;
// }).join(", ");
// console.log(uniqueElements); // вишня, груша, слива

// 3
// str = str.split(",");
// let uniqueElements = str.reduce((a,b) => {
